...
<div class="h-100 bg-white">
    <div class="row h-100 m-0 p-0">
        <div class="col-3 h-100 m-0 p-0 border-left border-right bordergray">
            <div class="left-memo-menu d-flex justify-content-between pt2">
                <div class="pl-3 pt-2">
                    {{ $name }}さん、こんにちは。
                </div>
                <div class="pr-1">
        ...
        <div class="col-9 h-100">
            @if ($select_memo)
                <form class="w-100 h-100" method="post">
                    ...
                    <input type="text" id="memo-title" name="edit_title" placeholder="タイトルを⼊⼒する..." value="{{ $select_memo->title }}" />
                    <textarea id="memo-content" name="edit_content" placeholder="内容を⼊⼒する...">{{ $select_memo->content }}</textarea>
                </form>
                @else
